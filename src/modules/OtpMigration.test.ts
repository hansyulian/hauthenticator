...
describe("Module: OtpMigration", () => {
  describe("OtpMigration.decode", () => {
    it("1. should be able to decode otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIQARgBIAEoew%3D%3D", () => {
      const result = OtpMigration.decode("otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIQARgBIAEoew%3D%3D");
    ...
    it("2. should be able to decode otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIKKgoGkQUSTmSUEgtuYW1ldGVzdDEyMxoNaXNzdWVydGVzdDEyMyABKAEwAhABGAUgASjIAw%3D%3D", () => {
      const result = OtpMigration.decode("otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIKKgoGkQUSTmSUEgtuYW1ldGVzdDEyMxoNaXNzdWVydGVzdDEyMyABKAEwAhABGAUgASjIAw%3D%3D");
      expect(result).toEqual({
        batchId: 456,
        batchIndex: 1,
        batchSize: 5,
  ...
  describe("OtpMigration.encode", () => {
    it("1. should be able to encode", () => {
      ...
      expect(result).toStrictEqual("otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIQARgBIAEoew%3D%3D");
    });
    it("2. should be able to encode", () => {
      ...
      expect(result).toStrictEqual("otpauth-migration://offline?data=CiQKBpEFEk5klBIIbmFtZXRlc3QaCmlzc3VlcnRlc3QgASgBMAIKKgoGkQUSTmSUEgtuYW1ldGVzdDEyMxoNaXNzdWVydGVzdDEyMyABKAEwAhABGAUgASjIAw%3D%3D");
    });
  });
